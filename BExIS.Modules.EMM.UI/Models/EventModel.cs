...
namespace BExIS.Modules.EMM.UI.Models
{
    public class EventModel
    {
        ...
        public List<string> JsonsKeys { get; set; }

        public string JsonKeyEmail { get; set; }
        public string JsonKeyFirstName { get; set; }
        public string JsonKeyLastName { get; set; }
        ...
        public EventModel(Event eEvent)
        {
            ...
            JsonKeyLastName = eEvent.JsonKeyLastName;
