...
function OnClickAdd(e, max) {
    ...
    if (NumberOfSourceInPackage <= parseInt(maxcardinality)) {
        $.post('/EMM/EventRegistration/AddMetadataAttributeUsage',
            {
                id: id,
                parentid: parentid,
                number: number,
...
function OnClickRemove(e) {
    ...
    if (value !== "") {
        ...
        if (NumberOfSourceInPackage > 1) {
            ...
            $
                .post('/EMM/EventRegistration/RemoveMetadataAttributeUsage',
                    {
                        id: id,
                        parentid: parentid,
                        number: number,
...
function OnClickUp(e) {
    ...
    if (value !== "") {
        ...
        $.post('/EMM/EventRegistration/UpMetadataAttributeUsage',
            {
                id: id,
                parentid: parentid,
                number: number,
...
function OnClickDown(e) {
    ...
    if (value !== "") {
        ...
        $.post('/EMM/EventRegistration/DownMetadataAttributeUsage',
            {
                id: id,
                parentid: parentid,
                number: number,
...
function UpdateWithEntity(componentId, number, inputid, inputattrnumber, entityid, entitytypeid, value) {
    ...
    $.post('/EMM/EventRegistration/UpdateComplexUsageWithEntity',
        {
            stepId: componentId,
            number: number,
            inputattrid: attrId,
...
function UpdateWithParty(componentId, number, partyid) {
    ...
    $.post('/EMM/EventRegistration/UpdateComplexUsageWithParty',
        {
            stepId: componentId,
            number: number,
            partyId: partyid
...
function UpdateSimpleMappingWithParty(componentId, xpath, partyid, value)
{
    ...
    $.post('/EMM/EventRegistration/UpdateSimpleUsageWithParty',
        {
            xpath: xpath,
            partyId: partyid
        },
...
function Add(e) {
    ...
    //alert(e.id);
    //alert(parentId);
    $.get('/EMM/EventRegistration/AddComplexUsage',
...
function Remove(e) {
    ...
    $.get('/EMM/EventRegistration/RemoveComplexUsage',
        { parentStepId: parentId, number: number },
        function (response) {
            $('#' + parentId).replaceWith(response);
            bindMinimap(true);
...
function Up(e) {
    ...
    $.get('/EMM/EventRegistration/UpComplexUsage',
        { parentStepId: parentId, number: number },
        function (response) {
            $('#' + parentId).replaceWith(response);
            bindMinimap(true);
...
function Down(e) {
    ...
    $.get('/EMM/EventRegistration/DownComplexUsage',
        { parentStepId: parentId, number: number },
        function (response) {
            $('#' + parentId).replaceWith(response);
            bindMinimap(true);
...
function Activate(e) {
    ...
    $.get('/EMM/EventRegistration/ActivateComplexUsage',
        {
            id: stepid
        },
        function (response) {
...
function ActivateFromChoice(e) {
    ...
    $.get('/EMM/EventRegistration/ActivateComplexUsageInAChoice',
        {
