...
namespace BExIS.Emm.Services.Event
{
    public class EventManager: IDisposable
    {
        ...
        /// </summary>
        public E.Event CreateEvent(string data, string name, string eventDate, string importantInformation, string location, string mailInformation, string eventLanguage, DateTime startDate, DateTime deadline, int participantsLimitation, bool waitingList, int waitingListLimitation, bool editAllowed, bool closed, string logInPassword, string emailBCC, string emailCC, string emailReply, string jsonKeyEmail, string jsonKeyFirstname, string jsonKeyLastname, string javaScriptPath)
        {
            ...
            newEvent.JsonKeyEmail = jsonKeyEmail;
            newEvent.JsonKeyFirstName = jsonKeyFirstname;
            newEvent.JsonKeyLastName = jsonKeyLastname;
